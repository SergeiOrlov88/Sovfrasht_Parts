...
**Экран съёмки.** Видоискатель с рамкой и подсказками, съёмка 1–3 фото или выбор из галереи, проверка качества. Обязательных кадров нет: достаточно шильдика или общего вида. Шильдик помечен как повышающий точность, а не как обязательный. (FR-CAP-01/02/03/06)
