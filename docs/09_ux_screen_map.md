...
Карта экранов MVP и основные пользовательские потоки продукта **Совфрахт Детали**. Ориентир по интерфейсу — интерактивный прототип (`Портотип/MarinePartID_Prototype.html`). Mobile-first, крупные зоны нажатия, работа одной рукой (NFR-COMPAT-02).
